...
-- -----------------------------------------------------------------------------
-- 目标数据库 : MySQL 8.x
-- 基线版本   : v1.4 (Resource Management, 2026-09-15)
--              v1.1 Team-Ready Baseline 之上，v1.4 增加资源域维护计划与报修工单表
...
-- =============================================================================
-- 6. room_maintenance 会议室维护计划表（v1.4 新增）
...
-- =============================================================================
-- 7. facility_repair_ticket 设施报修工单表（v1.4 新增）
